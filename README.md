...
- Ex-```AWS Fargate```, [Fargate on Firecracker](https://aws.amazon.com/blogs/containers/under-the-hood-fargate-data-plane/). Built  stealth mode product from 0 to 1 -> App Runner! (2021 GA)
