...
- Founding engineer of ```AWS App Runner```(2021 GA): https://aws.amazon.com/apprunner/, a new AWS service that provides a simplified infrastructure-less abstraction for multi-concurrent web applications & API-based services
- Founding engineer of ```Alexa Health & Wellness```(2019 GA): [New ways to manage your medications at home using Alexa](https://www.aboutamazon.com/news/devices/new-ways-to-manage-your-medications-at-home-using-alexa)
