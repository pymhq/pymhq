...
- Products working on: App Runner, [ECS Fargate](https://aws.amazon.com/blogs/containers/under-the-hood-fargate-data-plane/), Elastic Beanstalk, Lambda. Built  stealth mode product from 0 to 1 -> App Runner! (2021 GA)
